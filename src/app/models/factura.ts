export class Factura{
    ...
    constructor(factura_id: number,factura_fecha: Date, cliente_id: string, camaron_id: number ,factura_precio_camaron: number
        ,factura_subtotal: number, factura_iva: number, factura_precio_final: number){
